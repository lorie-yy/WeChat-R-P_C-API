...
INSERT INTO adminbd_licenseparams(id,code,cloudRankName,maxAPs,maxACs,maxUsers,vesion_type,product_type) VALUES (1,'CBSOF-CDS0047A','BCP8200-OS-STD',0,0,0,1,1);
...
INSERT INTO adminbd_licenseparams(id,code,cloudRankName,maxAPs,maxACs,maxUsers,vesion_type,product_type) VALUES (5,'CBSOF-CDS0095A','BCP8200-Ext-Map-0',0,0,0,1,3);

INSERT INTO adminbd_licenseparams(id,code,cloudRankName,maxAPs,maxACs,maxUsers,vesion_type,product_type) VALUES (6,'ZXSOF-CDS0004A','ZXWL OMCP',0,0,0,2,1);
INSERT INTO adminbd_licenseparams(id,code,cloudRankName,maxAPs,maxACs,maxUsers,vesion_type,product_type) VALUES (7,'ZXSOF-CDS0017A','ZXWL OMCP（精简版）',0,0,0,2,1);
